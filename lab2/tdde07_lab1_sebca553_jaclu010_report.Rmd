---
title: "tdde07_lab1_sebca553_jaclu010_report"
...
Analyzing this plot compared to the plots for all other variables shows that this feature is an important determinant of the probability that a woman works. This assumption is also explained by the summary of the glmModel from task a).
```{r}
summary(glmModel)
```
...
Thus, the probability that a woman with the described prerequisites is around $30\%$.
